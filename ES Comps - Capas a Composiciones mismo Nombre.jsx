...
// 
// txuku de ps-scripts.com sugiere el cambio de código para que aplique el nombre de Capa a la Composición de Capas.
// Exactamente modificar esta linea: compName = 'Comp ' + (compIndex + Math.pow(10, zeroPadding)).toString().substr(1);
// por esta linea: compName = doc.layers[layerIndex].name;
// ============================================================================
...
function createLayerComps(doc) {
	...
	for (layerIndex, compIndex; layerIndex >= 0; layerIndex--, compIndex++) {
		...
		compName = doc.layers[layerIndex].name;
