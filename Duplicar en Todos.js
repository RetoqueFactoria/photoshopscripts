...
function duplicateToAll(){
	...
	ungroupLayerset();
	alert('"Duplicar en Todos" Completado');
}
function ungroupLayerset(){
	...
	try {
		...
		alert('"Duplicar en Todos" ha encontrado un error. Please email the text below to cm@cameronmcefee.com \n' + 'Error with PS Script: Duplicate to All at [ungroupLayerset()] \n\n' + e);	
	}
}
