...
var effects =
{
	"Arriba Izq": { x: 20, y: 20, name: 'ok', hLoc: "left", vLoc: "top" },
	"Arriba": { x: 140, y: 20, name: '', hLoc: "center", vLoc: "top" },
	"Arriba Der": { x: 260, y: 20, name: '', hLoc: "right", vLoc: "top" },
	"Izq": { x: 20, y: 60, name: '', hLoc: "left", vLoc: "center" },
	"Cancelar": { x: 140, y: 60, name: 'cancel' },
	"Der": { x: 260, y: 60, name: '', hLoc: "right", vLoc: "center" },
	"Abajo Izq": { x: 20, y: 100, name: '', hLoc: "left", vLoc: "bottomEnum" },
	"Abajo": { x: 140, y: 100, name: '', hLoc: "center", vLoc: "bottomEnum" },
	"Abajo Der": { x: 260, y: 100, name: '', hLoc: "right", vLoc: "bottomEnum" }
};
...
{
	var dlg = new Window ('dialog', "Reflejo Completo", [ 0, 0, dialogWidth, dialogHeight ]);
	dlg.buttons = [];
