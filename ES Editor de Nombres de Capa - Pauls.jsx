...
try{
var win = new Window( 'dialog', 'Editor de Nombres de Capa' ); 
g = win.graphics;
...
win.title = win.g1.add('statictext',undefined,'Traducido por RETOQUE FACTORIA');
...
win.g5.spacing=10;
win.g5.rb1 = win.g5.add('radiobutton',undefined,'Usar seleccionadas');
win.g5.rb2 = win.g5.add('radiobutton',undefined,'Usar todas las Capas');
win.g5.rb1.value=true;
win.g10 =win.p1.add('group');
win.g10.orientation = "row";
win.g10.alignment='fill';
win.g10.rb1 = win.g10.add('radiobutton',undefined,'Prefijo');
win.g10.rb2 = win.g10.add('radiobutton',undefined,'Sufijo');
win.g10.rb3 = win.g10.add('radiobutton',undefined,'Borrar');
win.g10.rb4 = win.g10.add('radiobutton',undefined,'Insertar');
win.g10.rb5 = win.g10.add('radiobutton',undefined,'Remplazar');
win.g10.rb5.value=true;
win.g15 =win.p1.add('group');
win.g15.orientation = "row";
win.g15.alignment='fill';
win.g15.cb1 = win.g15.add('checkbox',undefined,'Crear Instantanea');
...
win.g200.st1 = win.g200.add('statictext',undefined,'Prefijo');
...
win.g300.st1 = win.g300.add('statictext',undefined,'Sufijo');
...
win.g400.rb1 = win.g400.add('radiobutton',undefined,'Inicio Caract.');
win.g400.rb2 = win.g400.add('radiobutton',undefined,'Ultimos Caract.');
win.g400.rb3 = win.g400.add('radiobutton',undefined,'Rango desde');
...
win.g410.st1 = win.g410.add('statictext',undefined,'Numero de Caracteres');
...
win.g500.st1 = win.g500.add('statictext',undefined,'Insertar');
...
win.g510.st1 = win.g510.add('statictext',undefined,'Posicion');
...
win.g600.st1 = win.g600.add('statictext',undefined,'Reemplazar:');
...
win.g610.st1 = win.g610.add('statictext',undefined,'Con:');
...
win.g620.cb2 = win.g620.add('checkbox',undefined,'May. y Minusculas');
...
win.g1000.bu1 = win.g1000.add('button',undefined,'Procesar');
win.g1000.bu1.preferredSize=[150,30];
win.g1000.bu2 = win.g1000.add('button',undefined,'Tecla Esc.');
    ...
    if(win.g400.rb1.value){
        if(win.g410.et1.text == ''){
         ...
         if(Number(win.g410.et1.text) <1 ){
             alert("No puedes remover CERO caracteres!");
             return;
             }
            win.close(0);
if(win.g5.rb1.value){var lList = selIdxNames;}else{var lList=allIdxNames;};
...
if(win.g600.et1.text == ''){
    alert("No se ingresaron valores para reemplazar!");
    return;
    }
    win.close(0);
